...
(
    ...
    "second" INTEGER,
    "calculation_id" UUID,
    CONSTRAINT "operand_PK" PRIMARY KEY ("id")
    );
...
(
    ...
    CONSTRAINT "calculation_operand_FK"   FOREIGN KEY ("operand_id")     REFERENCES "operand",
    CONSTRAINT "calculation_result_FK"    FOREIGN KEY ("result_id")      REFERENCES "result"
    );
